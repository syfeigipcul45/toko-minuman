            ...
            <table id="table-product" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    {{-- <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" id="">
                        ...
                        <td class="px-6 py-4">
                            <input type="text" id="small-input" name="nama_barang" wire:model="inputs.0.nama_barang"
                                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </td>
                        <td class="px-6 py-4">
                            <input type="number" id="small-input" min="0" name="quantity"
                                wire:model="inputs.0.quantity"
                                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </td>
                        <td class="px-6 py-4">
                            <select id="satuan" name="satuan" wire:model="inputs.0.satuan_id"
                    ...
                    @foreach ($inputs as $index => $input)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" id="">
                            ...
                            <td class="px-6 py-4">
                                <input type="number" id="small-input" min="0" name="quantity"
                                    wire:model="inputs.{{ $index }}.quantity"
                                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td class="px-6 py-4">
    ...
    <script>
        $(document).ready(function() {
            $("#satuan_id").change(function() {
                selectElement =
                  document.querySelector('#satuan_id');
                let satuan_id = selectElement.val;
                alert(satuan_id)
            });
        });
    </script>
