<div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
            <table id="table-barang" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    @forelse ($barangs as $barang)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button wire:click = "changeDelete({{ $barang->id }})" data-modal-target="popup-modal"
                        ...
                        @include('pages.barang.modal-delete')
                    @empty
                    @endforelse
                </tbody>
            </table>
